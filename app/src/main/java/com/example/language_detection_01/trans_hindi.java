...
public class trans_hindi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trans_hindi);

        edt = findViewById(R.id.idEdthindi);
        tvv = findViewById(R.id.tvout_hindi);
        clean = (Button) findViewById(R.id.clear_hindi);
        det = (Button) findViewById(R.id.idBtnDetectLanguage_hindi);
    ...
    public void downloadModal(String input) {
        ...
        HindiEnlishtrsnl.downloadModelIfNeeded(conditions).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(trans_hindi.this, "Please wait language modal is being downloaded.", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(trans_hindi.this, "Fail to download modal", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void translateLanguage(String input) {
        HindiEnlishtrsnl.translate(input).addOnSuccessListener(new OnSuccessListener<String>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(trans_hindi.this, "Fail to translate", Toast.LENGTH_SHORT).show();
            }
        });
    }
