...
public class trans_german extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trans_german);

        edt = findViewById(R.id.idEdtger);
        tvv = findViewById(R.id.tvout_ger);
        clean = (Button) findViewById(R.id.clear_ger);
        det = (Button) findViewById(R.id.idBtnDetectLanguage_ger);
    ...
    public void downloadModal(String input) {
        ...
        HindiEnlishtrsnl.downloadModelIfNeeded(conditions).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(trans_german.this, "Please wait language modal is being downloaded.", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(trans_german.this, "Fail to download modal", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void translateLanguage(String input) {
        HindiEnlishtrsnl.translate(input).addOnSuccessListener(new OnSuccessListener<String>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(trans_german.this, "Fail to translate", Toast.LENGTH_SHORT).show();
            }
        });
    }
