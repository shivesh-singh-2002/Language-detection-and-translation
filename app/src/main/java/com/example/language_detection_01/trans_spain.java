...
public class trans_spain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trans_spain);

        edt = findViewById(R.id.idEdtsp);
        tvv = findViewById(R.id.tvout_sp);
        clean = (Button) findViewById(R.id.clear_spain);
        det = (Button) findViewById(R.id.idBtnDetectLanguage_spain);
    ...
    public void downloadModal(String input) {
        ...
        HindiEnlishtrsnl.downloadModelIfNeeded(conditions).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(trans_spain.this, "Please wait language modal is being downloaded.", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(trans_spain.this, "Fail to download modal", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void translateLanguage(String input) {
        HindiEnlishtrsnl.translate(input).addOnSuccessListener(new OnSuccessListener<String>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(trans_spain.this, "Fail to translate", Toast.LENGTH_SHORT).show();
            }
        });
    }
