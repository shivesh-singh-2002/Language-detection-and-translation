...
public class chinese extends AppCompatActivity {
                ...
                .addOnFailureListener(
                        new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(chinese.this, "Fail to detect the text from image..", Toast.LENGTH_SHORT).show();
                            }
    ...
    public void processTxt(Text result) {
        ...
        if (resultText.isEmpty()) {
            ...
            Toast.makeText(chinese.this, "No Text ", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void detectLanguage(String string) {
        ...
        languageIdentifier.identifyLanguage(string).addOnSuccessListener(new OnSuccessListener<String>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(chinese.this, "Fail to detect language : \n" + e, Toast.LENGTH_SHORT).show();
            }
        });
    }
}